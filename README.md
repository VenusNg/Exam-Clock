...
<body>
  ...
  <script>
    // ========= YOUR TIMES (already set!) =========
    const examStartHour = 10;     // 10:00 AM
    const examStartMinute = 0;    // 00 minutes
    const readingMinutes = 10;    // 10 min reading
    const writingMinutes = 180;   // 3 hours exam
